function [B,S,stat] = sparse_coding(X_total, num_bases, beta, sparsity_func, epsilon, num_iters, batch_size, fname_save, pars, Binit, channels, resample_size)
...
if pars.display_images
    figure(1), display_network_nonsquare2(B,channels);
